...
def OLDfetch_and_save_alplakes_data_map(lake, date, depth, variables, model='delft3d-flow', verbose=True):
...
def OLDplot_alplakes_pcolormesh(data, skip=5, figsize=(14, 10), 
                            plot_temp=True, plot_velocity=True, cmap='jet',
                            quiver_scale=10, quiver_width=0.003):
    """
    Plot lake temperature and/or velocity currents
...
def OLDfetch_and_save_alplakes_point_data(lake, start_time, end_time, depth, lat, lon, 
                                       variables=['temperature', 'velocity'], 
                                       model='delft3d-flow', verbose=True):
    """
...
def OOLDplot_alplakes_transect_timeseries(data, lake, figsize=(18, 10), 
                                     plot_temp=True, cmap='jet',
                                     levels=20, time_range=None, time_step=None,
                                     save_fig=False, save_path=None, dpi=300, format='png'):
    """
    ...
    >>> # Plot every 6 hours and save as PDF
    >>> fig, axes = plot_alplakes_transect_timeseries(
    ...     data, 
    ...     lake='constance',
    ...     time_step='6h',
